...
from advanced_cnn_model import AdvancedCNN  # Import the AdvancedCNN model
...
torch.save(model.state_dict(), 'advanced_cnn_model.pth')
print("Saved the trained model to 'advanced_cnn_model.pth'")
